...
/*    */     return "Updated(id=" + getId() + ", key=" + getKey() + ", old=" + this.old + ", updated=" + this.updated + ")";
/*    */   }
/*    */   
/*    */   public int hashCode() {
...
/*    */     return !Intrinsics.areEqual(getId(), updated.getId()) ? false : (!Intrinsics.areEqual(getKey(), updated.getKey()) ? false : (!Intrinsics.areEqual(this.old, updated.old) ? false : (!!Intrinsics.areEqual(this.updated, updated.updated))));
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/user/storage/events/UserAttributeEvent$Updated.class
