...
/* 10 */     Intrinsics.checkNotNullParameter(attributes, "attributes"); attributes.getDouble(this.key); return (attributes.getDouble(this.key) != null) ? Integer.valueOf((int)attributes.getDouble(this.key).getValue()) : null;
/*    */   }
/*    */   
/*    */   @Nullable
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/user/cfg/model/proxy/AttributeIntProxy.class
