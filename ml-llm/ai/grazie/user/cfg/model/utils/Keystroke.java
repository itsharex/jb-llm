...
/*    */     
/* 44 */     this.meta = ((this.modifiers & 0x10) == 16); } @JvmStatic public static final void write$Self(@NotNull Keystroke self, @NotNull CompositeEncoder output, @NotNull SerialDescriptor serialDesc) { Intrinsics.checkNotNullParameter(self, "self"); Intrinsics.checkNotNullParameter(output, "output"); Intrinsics.checkNotNullParameter(serialDesc, "serialDesc"); output.encodeStringElement(serialDesc, 0, self.key); if (output.shouldEncodeElementDefault(serialDesc, 1) ? true : ((self.modifiers != 0))) output.encodeIntElement(serialDesc, 1, self.modifiers);  if (output.shouldEncodeElementDefault(serialDesc, 2) ? true : ((self.shift != (((self.modifiers & 0x2) == 2))))) output.encodeBooleanElement(serialDesc, 2, self.shift);  if (output.shouldEncodeElementDefault(serialDesc, 3) ? true : ((self.ctrl != (((self.modifiers & 0x4) == 4))))) output.encodeBooleanElement(serialDesc, 3, self.ctrl);  if (output.shouldEncodeElementDefault(serialDesc, 4) ? true : ((self.alt != (((self.modifiers & 0x8) == 8))))) output.encodeBooleanElement(serialDesc, 4, self.alt);  if (output.shouldEncodeElementDefault(serialDesc, 5) ? true : ((self.meta != (((self.modifiers & 0x10) == 16))))) output.encodeBooleanElement(serialDesc, 5, self.meta);  } public final boolean getMeta() { return this.meta; }
/*    */ 
/*    */   
...
/*    */       Keystroke.write$Self(value, compositeEncoder, serialDescriptor);
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/user/cfg/model/utils/Keystroke.class
