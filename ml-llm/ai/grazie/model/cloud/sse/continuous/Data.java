...
/*    */   @NotNull
/* 10 */   public static final Companion Companion = new Companion(null); @NotNull private final ContinuousSSEEventType type; @NotNull private static final Lazy<KSerializer<Object>> $cachedSerializer$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, Data$Companion$$cachedSerializer$delegate$1.INSTANCE);
/*    */ 
/*    */   
/*    */   public Data()
/*    */   {
/* 15 */     this.type = ContinuousSSEEventType.Data; } @JvmStatic public static final void write$Self(@NotNull Data self, @NotNull CompositeEncoder output, @NotNull SerialDescriptor serialDesc) { Intrinsics.checkNotNullParameter(self, "self"); Intrinsics.checkNotNullParameter(output, "output"); Intrinsics.checkNotNullParameter(serialDesc, "serialDesc"); output.encodeSerializableElement(serialDesc, 0, (SerializationStrategy)ContinuousSSEEventType$.serializer.INSTANCE, self.type); } @NotNull public final ContinuousSSEEventType getType() { return this.type; }
/*    */ 
/*    */   
/*    */   @Metadata(mv = {1, 7, 0}, k = 3, xi = 48)
/*    */   static final class Data$Companion$$cachedSerializer$delegate$1 extends Lambda implements Function0<KSerializer<Object>> {
...
/*    */       return (KSerializer<Data>)get$cachedSerializer$delegate().getValue();
/*    */     }
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/model/cloud/sse/continuous/Data.class
