...
/*    */   @NotNull
/* 19 */   public final Builder add(@NotNull LLMChatRole role, @NotNull String text) { Intrinsics.checkNotNullParameter(role, "role"); Intrinsics.checkNotNullParameter(text, "text"); return message(role, text); }
...
/* 22 */     Intrinsics.checkNotNullParameter(role, "role"); Intrinsics.checkNotNullParameter(text, "text"); this.messages.add(new LLMChatMessage(role, text));
/* 23 */     return this;
/*    */   }
/*    */   @NotNull
/* 26 */   public final Builder user(@NotNull String text) { Intrinsics.checkNotNullParameter(text, "text"); return message(LLMChatRole.User, text); }
/*    */   @NotNull
/* 28 */   public final Builder system(@NotNull String text) { Intrinsics.checkNotNullParameter(text, "text"); return message(LLMChatRole.System, text); }
/*    */   @NotNull
/* 30 */   public final Builder assistant(@NotNull String text) { Intrinsics.checkNotNullParameter(text, "text"); return message(LLMChatRole.Assistant, text); } @NotNull
/*    */   public final LLMChat build() {
/* 32 */     Collection<LLMChatMessage> $this$toTypedArray$iv = this.messages; int $i$f$toTypedArray = 0;
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/*    */ 
/*    */     
/* 53 */     Collection<LLMChatMessage> thisCollection$iv = $this$toTypedArray$iv;
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/model/llm/chat/LLMChat$Builder.class
