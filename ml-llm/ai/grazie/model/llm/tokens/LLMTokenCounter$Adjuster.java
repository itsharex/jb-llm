...
/*    */   
/* 12 */   public Adjuster(@NotNull Function1<LLMChatMessage, Integer> message, @NotNull Function1<LLMChat, Integer> chat) { this.message = message; this.chat = chat; } @NotNull private final Function1<LLMChat, Integer> chat; @NotNull public final Function1<LLMChatMessage, Integer> getMessage() { return this.message; } @NotNull public final Function1<LLMChat, Integer> getChat() { return this.chat; }
/*    */ 
/*    */   
/*    */   @NotNull
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/model/llm/tokens/LLMTokenCounter$Adjuster.class
