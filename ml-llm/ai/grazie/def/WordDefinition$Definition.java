...
/* 21 */     this.topic = topic;
/* 22 */     this.tags = tags;
/* 23 */     this.content_link = content_link; } @Nullable private final String topic; @Nullable private final String tags; @Nullable private final String content_link; @JvmStatic public static final void write$Self(@NotNull Definition self, @NotNull CompositeEncoder output, @NotNull SerialDescriptor serialDesc) { Intrinsics.checkNotNullParameter(self, "self"); Intrinsics.checkNotNullParameter(output, "output"); Intrinsics.checkNotNullParameter(serialDesc, "serialDesc"); output.encodeStringElement(serialDesc, 0, self.definition); if (output.shouldEncodeElementDefault(serialDesc, 1) ? true : ((self.id != -1))) output.encodeIntElement(serialDesc, 1, self.id);  if (output.shouldEncodeElementDefault(serialDesc, 2) ? true : ((self.topic != null))) output.encodeNullableSerializableElement(serialDesc, 2, (SerializationStrategy)StringSerializer.INSTANCE, self.topic);  if (output.shouldEncodeElementDefault(serialDesc, 3) ? true : ((self.tags != null))) output.encodeNullableSerializableElement(serialDesc, 3, (SerializationStrategy)StringSerializer.INSTANCE, self.tags);  if (output.shouldEncodeElementDefault(serialDesc, 4) ? true : ((self.content_link != null))) output.encodeNullableSerializableElement(serialDesc, 4, (SerializationStrategy)StringSerializer.INSTANCE, self.content_link);  } @Nullable public final String getContent_link() { return this.content_link; }
/*    */ 
/*    */   
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/def/WordDefinition$Definition.class
