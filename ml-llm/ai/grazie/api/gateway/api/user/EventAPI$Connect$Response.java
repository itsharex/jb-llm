...
/*    */   
/* 13 */   public Response(@NotNull Set<UserAttributeEvent> events) { this.events = events; } @NotNull private final Set<UserAttributeEvent> events; @JvmStatic public static final void write$Self(@NotNull Response self, @NotNull CompositeEncoder output, @NotNull SerialDescriptor serialDesc) { Intrinsics.checkNotNullParameter(self, "self"); Intrinsics.checkNotNullParameter(output, "output"); Intrinsics.checkNotNullParameter(serialDesc, "serialDesc"); output.encodeSerializableElement(serialDesc, 0, (SerializationStrategy)new LinkedHashSetSerializer(UserAttributeEvent.Companion.serializer()), self.events); } @NotNull public final Set<UserAttributeEvent> getEvents() { return this.events; }
/*    */ 
/*    */   
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/api/gateway/api/user/EventAPI$Connect$Response.class
