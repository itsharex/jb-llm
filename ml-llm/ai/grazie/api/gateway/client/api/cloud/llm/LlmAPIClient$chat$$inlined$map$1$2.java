...
public final class null<T> implements FlowCollector {
  ...
  public final Object emit(Object value, @NotNull Continuation paramContinuation) {
    // Byte code:
    //   0: aload_2
    //   1: instanceof ai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$chat$$inlined$map$1$2$1
    //   4: ifeq -> 36
    //   7: aload_2
    //   8: checkcast ai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$chat$$inlined$map$1$2$1
    //   11: astore_3
    //   12: aload_3
    //   13: getfield label : I
    //   16: ldc -2147483648
    ...
    //   30: putfield label : I
    //   33: goto -> 46
    //   36: new ai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$chat$$inlined$map$1$2$1
    //   39: dup
    //   40: aload_0
    //   41: aload_2
    //   42: invokespecial <init> : (Lai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$chat$$inlined$map$1$2;Lkotlin/coroutines/Continuation;)V
    //   45: astore_3
    //   46: aload_3
    ...
    //   111: pop
    //   112: checkcast ai/grazie/api/gateway/api/cloud/llm/LlmAPI$Chat$Stream$V3$Response
    //   115: astore #10
    //   117: iconst_0
    //   118: istore #11
    //   120: aload #10
    ...
    //   89	9	0	this	Lai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$chat$$inlined$map$1$2;
    ...
    //   117	8	10	it	Lai/grazie/api/gateway/api/cloud/llm/LlmAPI$Chat$Stream$V3$Response;
    //   120	5	11	$i$a$-map-LlmAPIClient$chat$2	I
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$chat$$inlined$map$1$2.class
