...
public final class null<T> implements FlowCollector {
  ...
  public final Object emit(Object value, @NotNull Continuation paramContinuation) {
    // Byte code:
    //   0: aload_2
    //   1: instanceof ai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$complete$$inlined$receiveContinuousSSE$default$3$2$1
    //   4: ifeq -> 36
    //   7: aload_2
    //   8: checkcast ai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$complete$$inlined$receiveContinuousSSE$default$3$2$1
    //   11: astore_3
    //   12: aload_3
    //   13: getfield label : I
    //   16: ldc -2147483648
    ...
    //   30: putfield label : I
    //   33: goto -> 46
    //   36: new ai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$complete$$inlined$receiveContinuousSSE$default$3$2$1
    //   39: dup
    //   40: aload_0
    //   41: aload_2
    //   42: invokespecial <init> : (Lai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$complete$$inlined$receiveContinuousSSE$default$3$2;Lkotlin/coroutines/Continuation;)V
    //   45: astore_3
    //   46: aload_3
    ...
    //   152: dup
    //   153: ldc 'null cannot be cast to non-null type ai.grazie.api.gateway.api.cloud.llm.LlmAPI.Complete.Stream.V3.Response'
    //   155: invokespecial <init> : (Ljava/lang/String;)V
    //   158: athrow
    //   159: checkcast ai/grazie/api/gateway/api/cloud/llm/LlmAPI$Complete$Stream$V3$Response
    ...
    //   89	39	0	this	Lai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$complete$$inlined$receiveContinuousSSE$default$3$2;
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/api/gateway/client/api/cloud/llm/LlmAPIClient$complete$$inlined$receiveContinuousSSE$default$3$2.class
