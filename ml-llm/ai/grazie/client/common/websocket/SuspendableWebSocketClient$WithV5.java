...
/* 35 */     this.client = client; } private final Object appendHeaders(RequestOptions options, Continuation $completion) {
/*    */     AuthData authData;
/* 37 */     if ((AuthData)$completion.getContext().get((CoroutineContext.Key)AuthData.Key) == null) { (AuthData)$completion.getContext().get((CoroutineContext.Key)AuthData.Key); throw new IllegalStateException("For v5 requests metadata must be set"); }
/*    */     
/* 39 */     if ((AuthServiceToken)$completion.getContext().get((CoroutineContext.Key)AuthServiceToken.Key) == null || ((AuthServiceToken)$completion.getContext().get((CoroutineContext.Key)AuthServiceToken.Key)).getToken() == null) ((AuthServiceToken)$completion.getContext().get((CoroutineContext.Key)AuthServiceToken.Key)).getToken();  return ((AuthServiceToken)$completion.getContext().get((CoroutineContext.Key)AuthServiceToken.Key)).getToken().append(authData.getToken(), 
/* 40 */         authData.getOriginalUserToken(), 
/* 41 */         authData.getOriginalServiceToken(), 
/* 42 */         authData.getGrazieAgent(), 
/* 43 */         options);
/*    */   }
/*    */   
/*    */   @Nullable
/*    */   public Object connect(@NotNull String url, @NotNull RequestOptions options, @NotNull Function2 body, @NotNull Continuation<? super Unit> paramContinuation) {
/*    */     // Byte code:
/*    */     //   0: aload #4
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/client/common/websocket/SuspendableWebSocketClient$WithV5.class
