...
/* 137 */     public static final SpacyBaseLanguage$compilePrefix$4 INSTANCE = new SpacyBaseLanguage$compilePrefix$4(); SpacyBaseLanguage$compilePrefix$4() { super(1); } @NotNull public final CharSequence invoke(@NotNull String it) { Intrinsics.checkNotNullParameter(it, "it"); return "^" + it; } } @NotNull public final Regex compileSuffix(@NotNull List cases) { Intrinsics.checkNotNullParameter(cases, "cases"); Iterable $this$map$iv = cases; int $i$f$map = 0; Iterable iterable1 = $this$map$iv; Collection<String> collection = new ArrayList(CollectionsKt.collectionSizeOrDefault($this$map$iv, 10)); int $i$f$mapTo = 0;
...
/* 144 */     public static final SpacyBaseLanguage$compileSuffix$2 INSTANCE = new SpacyBaseLanguage$compileSuffix$2(); SpacyBaseLanguage$compileSuffix$2() { super(1); } @NotNull public final CharSequence invoke(@NotNull String it) { Intrinsics.checkNotNullParameter(it, "it"); return it + "$"; } } @NotNull public final Regex compileInfix(@NotNull List cases) { Intrinsics.checkNotNullParameter(cases, "cases"); Iterable $this$map$iv = cases; int $i$f$map = 0; Iterable iterable1 = $this$map$iv; Collection<String> collection = new ArrayList(CollectionsKt.collectionSizeOrDefault($this$map$iv, 10)); int $i$f$mapTo = 0;
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/nlp/tokenizer/spacy/SpacyBaseLanguage.class
