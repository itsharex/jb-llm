...
/*    */   public static final class ExtensionsKt$toInefficientSequenceTokenizer$2 implements NonDestructiveSequenceTokenizer { ExtensionsKt$toInefficientSequenceTokenizer$2(NonDestructiveCharSequenceTokenizer $self) {} @NotNull
/* 28 */     public Sequence<Tokenizer.Token> tokenizeAsSequence(@NotNull Sequence text) { Intrinsics.checkNotNullParameter(text, "text"); String string = SequencesKt.joinToString$default(text, "", null, null, 0, null, ExtensionsKt$toInefficientSequenceTokenizer$2$tokenizeAsSequence$string$1.INSTANCE, 30, null);
...
/*    */       public static final ExtensionsKt$toInefficientSequenceTokenizer$2$tokenizeAsSequence$string$1 INSTANCE = new ExtensionsKt$toInefficientSequenceTokenizer$2$tokenizeAsSequence$string$1();
/*    */       ExtensionsKt$toInefficientSequenceTokenizer$2$tokenizeAsSequence$string$1() { super(1); }
/*    */       @NotNull
/*    */       public final CharSequence invoke(char it) { return String.valueOf(it); } } }
/*    */   @NotNull
...
/*    */   public static final class ExtensionsKt$toInefficientCharSequenceTokenizer$1 implements CharSequenceTokenizer { ExtensionsKt$toInefficientCharSequenceTokenizer$1(Tokenizer $self) {} @NotNull
/* 43 */     public Sequence<Tokenizer.Token> tokenizeAsSequence(@NotNull CharSequence text) { Intrinsics.checkNotNullParameter(text, "text"); return CollectionsKt.asSequence(this.$self.tokenize(text.toString())); }
/*    */      }
/*    */ 
/*    */   
/*    */   @NotNull
...
/*    */   public static final class ExtensionsKt$toInefficientCharSequenceTokenizer$2 implements NonDestructiveCharSequenceTokenizer { ExtensionsKt$toInefficientCharSequenceTokenizer$2(NonDestructiveTokenizer $self) {} @NotNull
/* 56 */     public Sequence<Tokenizer.Token> tokenizeAsSequence(@NotNull CharSequence text) { Intrinsics.checkNotNullParameter(text, "text"); return CollectionsKt.asSequence(this.$self.tokenize(text.toString())); }
/*    */      }
/*    */ 
/*    */ 
/*    */   
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/nlp/tokenizer/sequence/ExtensionsKt.class
