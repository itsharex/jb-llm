...
/*    */ 
/*    */ @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000\032\n\002\030\002\n\002\030\002\n\000\n\002\020$\n\002\030\002\n\002\020\b\n\002\b\003\030\000 \0072\0020\001:\001\007B\031\022\022\020\002\032\016\022\004\022\0020\004\022\004\022\0020\0050\003¢\006\002\020\006¨\006\b"}, d2 = {"Lai/grazie/nlp/encoder/tiktoken/cl100k/TiktokenCL100KBaseEncoder;", "Lai/grazie/nlp/encoder/TiktokenEncoder;", "vocabulary", "", "Lai/grazie/nlp/encoder/ByteArrayKey;", "", "(Ljava/util/Map;)V", "Companion", "nlp-encoder-tiktoken-cl100k-base"})
/*    */ public final class TiktokenCL100KBaseEncoder extends TiktokenEncoder {
/* 10 */   public TiktokenCL100KBaseEncoder(@NotNull Map vocabulary) { super(
/* 11 */         vocabulary, 
/* 12 */         PATTERN, 
/* 13 */         -1); }
/*    */ 
...
/* 17 */       //   57	408	20	$result	Ljava/lang/Object; } @DebugMetadata(f = "TiktokenCL100KBaseEncoder.kt", l = {20}, i = {}, s = {}, n = {}, m = "load", c = "ai.grazie.nlp.encoder.tiktoken.cl100k.TiktokenCL100KBaseEncoder$Companion") @Metadata(mv = {1, 7, 0}, k = 3, xi = 48) static final class TiktokenCL100KBaseEncoder$Companion$load$1 extends ContinuationImpl { int label; TiktokenCL100KBaseEncoder$Companion$load$1(Continuation $completion) { super($completion); } @Nullable public final Object invokeSuspend(@NotNull Object $result) { this.result = $result; this.label |= Integer.MIN_VALUE; return TiktokenCL100KBaseEncoder.Companion.this.load(null, (Continuation<? super TiktokenEncoder>)this); } } } @NotNull private static final Regex PATTERN = new Regex("('s|'S|'t|'T|'re|'Re|'rE|'RE|'ve|'Ve|'vE|'VE|'m|'M|'ll|'Ll|'lL|'LL|'d|'D)|[^\\r\\n\\p{L}\\p{N}]?\\p{L}+|\\p{N}{1,3}| ?[^\\s\\p{L}\\p{N}]+[\\r\\n]*|\\s*[\\r\\n]+|\\s+(?!\\S)|\\s+");
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/nlp/encoder/tiktoken/cl100k/TiktokenCL100KBaseEncoder.class
