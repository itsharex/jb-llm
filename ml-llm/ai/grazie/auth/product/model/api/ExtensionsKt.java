...
/* 24 */     Intrinsics.checkNotNullParameter($this$splash, "<this>"); return ($this$splash instanceof AuthFlowWithProduct) ? ProductSplashes.INSTANCE.get(((AuthFlowWithProduct)$this$splash).getProduct()) : null;
/*    */   } @NotNull
/*    */   public static final AuthFlow getAuth(@NotNull Product $this$auth) {
/* 27 */     Intrinsics.checkNotNullParameter($this$auth, "<this>"); return ProductsAuthFlow.INSTANCE.get($this$auth);
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/auth/product/model/api/ExtensionsKt.class
