...
/*  98 */     Intrinsics.checkNotNullParameter(path, "path"); return new DataLoader.Path("build/processedResources/" + PlatformKt.<String>forPlatform("js", "jvm") + "/main", path);
/*     */   }
/*     */   
/*     */   private final File file(String path) {
/* 102 */     File file1 = new File(path(new DataLoader.Path(path)).toRelativePath()), it = file1;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 148 */     int $i$a$-takeIf-TestResources$file$1 = 0;
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/mpp/TestResources.class
