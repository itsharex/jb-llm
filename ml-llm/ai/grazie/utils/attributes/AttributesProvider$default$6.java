...
/*    */ final class AttributesProvider$default$6
/*    */   extends Lambda
...
/* 43 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, Double.valueOf(((Attributes.Value.Double)value).getValue()));
/*    */   }
/*    */   
/*    */   AttributesProvider$default$6(Function3<Attributes.Key.Double, Entity, Double, Attributes.Value.Double> $set) {
/*    */     super(3);
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/attributes/AttributesProvider$default$6.class
