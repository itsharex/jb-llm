...
/*    */ {
/*    */   AttributesProvider$default$2(Function3<Attributes.Key, Entity, Attributes.Value, Attributes.Value> $set) {
/*    */     super(3);
/*    */   }
/*    */   
/*    */   @NotNull
/*    */   public final Attributes.Value invoke(@NotNull Attributes.Key key, Object id, @NotNull Attributes.Value value) {
/* 26 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, value);
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/attributes/AttributesProvider$default$2.class
