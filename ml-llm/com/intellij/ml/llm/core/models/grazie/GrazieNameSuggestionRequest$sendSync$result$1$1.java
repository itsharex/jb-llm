...
@DebugMetadata(f = "GrazieNameSuggestionRequest.kt", l = {23, 23}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "com.intellij.ml.llm.core.models.grazie.GrazieNameSuggestionRequest$sendSync$result$1$1")
@Metadata(mv = {1, 8, 0}, k = 3, xi = 48, d1 = {"\000\n\n\000\n\002\020\016\n\002\030\002\020\000\032\004\030\0010\001*\0020\002H@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"})
final class null extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
  int label;
  
  null(LLMChat $chat, Continuation $completion) {
    super(2, $completion);
  }
  ...
  public final Continuation<Unit> create(@Nullable Object value, @NotNull Continuation<? super null> $completion) {
    return (Continuation<Unit>)new Object(GrazieNameSuggestionRequest.this, this.$chat, $completion);
  }
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/com/intellij/ml/llm/core/models/grazie/GrazieNameSuggestionRequest$sendSync$result$1$1.class
