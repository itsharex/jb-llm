...
/* 87 */     Intrinsics.checkNotNullParameter($this$buttonsGroup, "$this$buttonsGroup"); if (LLMOptionsApplicabilityFilter.Companion.isOptionApplicable(LLMFeatureId.NAME_SUGGESTION))
/* 88 */       Panel.row$default($this$buttonsGroup, null, new Function1<Row, Unit>() { public final void invoke(@NotNull Row $this$row) {
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/com/intellij/ml/llm/core/settings/LLMConfigurable$createPanel$2$1$5.class
