...
/*     */ final class GrazieAuthService$authenticate$2
...
/*     */     Deferred ourAsync;
/* 246 */     Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); $this$coroutineScope = (CoroutineScope)this.L$0;
/* 247 */         ourAsync = BuildersKt.async$default($this$coroutineScope, null, null, new GrazieAuthService$authenticate$2$ourAsync$1(this.$project, null), 3, null);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */         
/* 281 */         GrazieAuthService.access$setAuthJob$p(GrazieAuthService.this, (Job)ourAsync);
/* 282 */         this.label = 1; if (ourAsync.await((Continuation)this) == object) return object;  ourAsync.await((Continuation)this);
/* 283 */         return Unit.INSTANCE;case 1: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); return Unit.INSTANCE; }
/*     */     
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/com/intellij/ml/llm/core/grazieAPI/GrazieAuthService$authenticate$2.class
