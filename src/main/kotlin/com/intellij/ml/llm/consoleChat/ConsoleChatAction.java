...
/*    */ 
/*    */ @Metadata(mv = {1, 8, 0}, k = 1, xi = 48, d1 = {"\000 \n\002\030\002\n\002\030\002\n\002\b\002\n\002\030\002\n\000\n\002\020\002\n\000\n\002\030\002\n\002\b\002\b\007\030\000 \t2\0020\001:\001\tB\005¢\006\002\020\002J\020\020\005\032\0020\0062\006\020\007\032\0020\bH\026R\016\020\003\032\0020\004X\004¢\006\002\n\000¨\006\n"}, d2 = {"Lcom/intellij/ml/llm/consoleChat/ConsoleChatAction;", "Lcom/intellij/openapi/actionSystem/AnAction;", "()V", "scope", "Lkotlinx/coroutines/CoroutineScope;", "actionPerformed", "", "e", "Lcom/intellij/openapi/actionSystem/AnActionEvent;", "Companion", "intellij.ml.llm"})
/*    */ @VisibleForTesting
/*    */ public final class ConsoleChatAction extends AnAction {
/*    */   @NotNull
/*    */   public static final Companion Companion = new Companion(null);
/*    */   
/* 26 */   public ConsoleChatAction() { super(LLMBundle.message("action.ConsoleChatAction.text", new Object[0]));
/* 27 */     this.scope = CoroutineScopeKt.CoroutineScope((CoroutineContext)EmptyCoroutineContext.INSTANCE); } @NotNull private final CoroutineScope scope; public void actionPerformed(@NotNull AnActionEvent e) { Editor editor; PsiFile file;
/*    */     Project project;
/* 29 */     Intrinsics.checkNotNullParameter(e, "e"); if ((Editor)e.getData(CommonDataKeys.EDITOR) == null) { (Editor)e.getData(CommonDataKeys.EDITOR); return; }
/* 30 */      if ((PsiFile)e.getData(CommonDataKeys.PSI_FILE) == null) { (PsiFile)e.getData(CommonDataKeys.PSI_FILE); return; }
/* 31 */      if (e.getProject() == null) { e.getProject(); return; }
/* 32 */      Intrinsics.checkNotNullExpressionValue(editor.getDocument(), "editor.document"); Document document = editor.getDocument();
/* 33 */     BuildersKt.launch$default(this.scope, null, null, new ConsoleChatAction$actionPerformed$1(project, file, document, null), 3, null); } @DebugMetadata(f = "ConsoleChatAction.kt", l = {34}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "com.intellij.ml.llm.consoleChat.ConsoleChatAction$actionPerformed$1") @Metadata(mv = {1, 8, 0}, k = 3, xi = 48, d1 = {"\000\n\n\000\n\002\020\002\n\002\030\002\020\000\032\0020\001*\0020\002H@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}) static final class ConsoleChatAction$actionPerformed$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> { int label; ConsoleChatAction$actionPerformed$1(Project $project, PsiFile $file, Document $document, Continuation $completion) { super(2, $completion); } @Nullable public final Object invokeSuspend(@NotNull Object $result) { Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1);
...
/*    */     
/*    */     @Nullable
/*    */     public final Object continueConversation(@NotNull Project project, @NotNull PsiFile file, @NotNull Document document, @NotNull Continuation<? super String> param1Continuation) {
/*    */       // Byte code:
/*    */       //   0: aload #4
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/com/intellij/ml/llm/consoleChat/ConsoleChatAction.class
