...
/*    */ public final class CodeChatMessagePart
...
/*    */   
/*    */   public CodeChatMessagePart(@NotNull String text, @Nullable String language, @NotNull ChatMessagePartKind kind) {
/* 92 */     this.text = text; this.language = language; this.kind = kind; } @NotNull public String getText() { return this.text; } @Nullable public final String getLanguage() { return this.language; } @NotNull public ChatMessagePartKind getKind() { return this.kind; }
/*    */ 
/*    */   
/*    */   @NotNull
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/com/intellij/ml/llm/core/chat/messages/ChatMessagePart$CodeChatMessagePart.class
