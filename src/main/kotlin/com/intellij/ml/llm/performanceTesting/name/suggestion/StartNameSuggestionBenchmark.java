...
/* 16 */     if (BuildersKt.withContext((CoroutineContext)Dispatchers.getDefault(), new StartNameSuggestionBenchmark$doExecute$2(null), $completion) == IntrinsicsKt.getCOROUTINE_SUSPENDED()) return BuildersKt.withContext((CoroutineContext)Dispatchers.getDefault(), new StartNameSuggestionBenchmark$doExecute$2(null), $completion);  BuildersKt.withContext((CoroutineContext)Dispatchers.getDefault(), new StartNameSuggestionBenchmark$doExecute$2(null), $completion); return Unit.INSTANCE; } @DebugMetadata(f = "StartNameSuggestionBenchmark.kt", l = {}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "com.intellij.ml.llm.performanceTesting.name.suggestion.StartNameSuggestionBenchmark$doExecute$2") @Metadata(mv = {1, 8, 0}, k = 3, xi = 48, d1 = {"\000\n\n\000\n\002\020\002\n\002\030\002\020\000\032\0020\001*\0020\002H@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}) @SourceDebugExtension({"SMAP\nStartNameSuggestionBenchmark.kt\nKotlin\n*S Kotlin\n*F\n+ 1 StartNameSuggestionBenchmark.kt\ncom/intellij/ml/llm/performanceTesting/name/suggestion/StartNameSuggestionBenchmark$doExecute$2\n+ 2 service.kt\ncom/intellij/openapi/components/ServiceKt\n*L\n1#1,20:1\n43#2,3:21\n*S KotlinDebug\n*F\n+ 1 StartNameSuggestionBenchmark.kt\ncom/intellij/ml/llm/performanceTesting/name/suggestion/StartNameSuggestionBenchmark$doExecute$2\n*L\n17#1:21,3\n*E\n"}) static final class StartNameSuggestionBenchmark$doExecute$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> { int label; StartNameSuggestionBenchmark$doExecute$2(Continuation $completion) { super(2, $completion); } @Nullable public final Object invokeSuspend(@NotNull Object $result) { int $i$f$service; Class<NameSuggestionBenchmarkService> serviceClass$iv; Object object; IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1);
/* 17 */           $i$f$service = 0;
/*    */ 
/*    */ 
/*    */           
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/com/intellij/ml/llm/performanceTesting/name/suggestion/StartNameSuggestionBenchmark.class
