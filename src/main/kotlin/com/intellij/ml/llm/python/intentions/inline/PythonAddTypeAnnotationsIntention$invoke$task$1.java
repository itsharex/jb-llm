...
/*    */ public final class PythonAddTypeAnnotationsIntention$invoke$task$1
...
/* 59 */     super($project, $super_call_param$1);
/*    */   }
/* 61 */   public void run(@NotNull ProgressIndicator indicator) { Intrinsics.checkNotNullParameter(indicator, "indicator"); String usagesText = PythonContextUtils.INSTANCE.getFunctionUsagesText(this.$function);
/*    */     
...
/*    */ 
/*    */       
/* 68 */       StringsKt.trimIndent("\nAdd return value and parameters type annotations for function (" + this.$functionName + ")\n\nUsages of the " + this.$functionName + ":\n" + usagesText + "   \n          ");
/*    */     
/* 70 */     LLMBaseResponse response = SenderKt.sendEditRequest$default(
/* 71 */         this.$project, 
/* 72 */         this.$functionText, 
/* 73 */         instruction, null, null, null, null, 120, null);
/*    */ 
/*    */     
/* 76 */     if (response != null) {
/* 77 */       LLMResponseChoice lLMResponseChoice1 = (LLMResponseChoice)CollectionsKt.firstOrNull(response.getSuggestions()); PythonAddTypeAnnotationsIntention pythonAddTypeAnnotationsIntention = PythonAddTypeAnnotationsIntention.this; Project project = this.$project; PyFunction pyFunction = this.$function; Editor editor = this.$editor; LLMResponseChoice it = lLMResponseChoice1; int $i$a$-let-PythonAddTypeAnnotationsIntention$invoke$task$1$run$1 = 0;
/* 78 */       PythonAddTypeAnnotationsIntention.access$getLogger$p(pythonAddTypeAnnotationsIntention).info("Suggested change: " + it);
/*    */       
/* 80 */       ActionsKt.invokeLater$default(null, new PythonAddTypeAnnotationsIntention$invoke$task$1$run$1$1(pythonAddTypeAnnotationsIntention, it, pyFunction, editor), 1, null);
/*    */       (LLMResponseChoice)CollectionsKt.firstOrNull(response.getSuggestions());
/*    */     }  } @Metadata(mv = {1, 8, 0}, k = 3, xi = 48, d1 = {"\000\b\n\000\n\002\020\002\n\000\020\000\032\0020\001H\n¢\006\002\b\002"}, d2 = {"<anonymous>", "", "invoke"})
/* 83 */   static final class PythonAddTypeAnnotationsIntention$invoke$task$1$run$1$1 extends Lambda implements Function0<Unit> { private static final void invoke$lambda$0(LLMResponseChoice $it, PyFunction $function, Project $project, Editor $editor) { Intrinsics.checkNotNullParameter($it, "$it"); Intrinsics.checkNotNullParameter($function, "$function"); Intrinsics.checkNotNullParameter($project, "$project"); Intrinsics.checkNotNullExpressionValue(StringUtil.convertLineSeparators($it.getText()), "convertLineSeparators(it.text)"); String suggestion = StringUtil.convertLineSeparators($it.getText());
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/com/intellij/ml/llm/python/intentions/inline/PythonAddTypeAnnotationsIntention$invoke$task$1.class
