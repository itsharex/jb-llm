...
/*     */ 
/*     */ 
/*     */ @DebugMetadata(f = "LLMCommitMessageAction.kt", l = {87, 92, 98}, i = {2}, s = {"L$0"}, n = {"messageBuilder"}, m = "invokeSuspend", c = "com.intellij.ml.llm.vcs.LLMCommitMessageAction$actionPerformed$task$1$run$1")
/*     */ @Metadata(mv = {1, 8, 0}, k = 3, xi = 48, d1 = {"\000\n\n\000\n\002\020\002\n\002\030\002\020\000\032\0020\001*\0020\002H@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"})
/*     */ final class LLMCommitMessageAction$actionPerformed$task$1$run$1
...
/*     */   int label;
/*     */   
/*     */   LLMCommitMessageAction$actionPerformed$task$1$run$1(LLMCommitMessageAction $receiver, Collection<Change> $includedSet, int $numberOfFiles, CompositeStatisticsIdeActivity $activity, CommitMessage $commitMessageUi, Continuation $completion) {
/*     */     super(2, $completion);
/*     */   }
/*     */   
/*     */   @Nullable
...
/*     */     //   44	333	1	$result	Ljava/lang/Object;
/*     */   }
/*     */   
/*     */   @NotNull
/*     */   public final Continuation<Unit> create(@Nullable Object value, @NotNull Continuation<? super LLMCommitMessageAction$actionPerformed$task$1$run$1> $completion) {
/*     */     return (Continuation<Unit>)new LLMCommitMessageAction$actionPerformed$task$1$run$1(LLMCommitMessageAction.this, this.$includedSet, this.$numberOfFiles, this.$activity, this.$commitMessageUi, $completion);
/*     */   }
/*     */   
/*     */   @Nullable
/*     */   public final Object invoke(@NotNull CoroutineScope p1, @Nullable Continuation<?> p2) {
/*     */     return ((LLMCommitMessageAction$actionPerformed$task$1$run$1)create(p1, p2)).invokeSuspend(Unit.INSTANCE);
/*     */   }
/*     */   
/*     */   @Metadata(mv = {1, 8, 0}, k = 3, xi = 48, d1 = {"\000\f\n\000\n\002\020\002\n\002\030\002\n\000\020\000\032\0020\001*\0020\002H\n¢\006\002\b\003"}, d2 = {"<anonymous>", "", "Lai/grazie/model/llm/chat/LLMChat$Builder;", "invoke"})
/*     */   static final class LLMCommitMessageAction$actionPerformed$task$1$run$1$chat$1
/*     */     extends Lambda
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/com/intellij/ml/llm/vcs/LLMCommitMessageAction$actionPerformed$task$1$run$1.class
