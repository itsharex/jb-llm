...
/* 15 */     this.type = type; this.data = data; } @NotNull public final Type getType() { return this.type; } @NotNull public final byte[] getData() { return this.data; }
...
/* 22 */   public static final class Close extends Frame { public Close() { super(SuspendableWebSocketClient.Frame.Type.CLOSE, new byte[0]); } }
