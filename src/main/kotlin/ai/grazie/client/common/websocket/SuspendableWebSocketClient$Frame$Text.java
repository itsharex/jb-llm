...
/* 24 */     super(SuspendableWebSocketClient.Frame.Type.TEXT, StringsKt.encodeToByteArray(text)); this.text = text; } @NotNull public final String getText() { return this.text; }
/*    */ 
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/client/common/websocket/SuspendableWebSocketClient$Frame$Text.class
