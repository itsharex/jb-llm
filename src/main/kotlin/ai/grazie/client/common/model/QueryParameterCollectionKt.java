...
/*    */ 
/*    */     
/* 56 */     Iterator iterator = $this$forEach$iv.iterator(); if (iterator.hasNext()) { Object element$iv = iterator.next(); Map.Entry it = (Map.Entry)element$iv; int $i$a$-forEach-QueryParameterCollectionKt$of$1 = 0; Collection $this$toTypedArray$iv = (Collection)it.getValue(); int $i$f$toTypedArray = 0;
/* 57 */       Collection thisCollection$iv = $this$toTypedArray$iv; }
...
/* 60 */       Collection thisCollection$iv = $this$toTypedArray$iv;
/* 61 */       parameters.set((String)value.getFirst(), (String[])thisCollection$iv.toArray((Object[])new String[0])); b++;
/* 62 */     }  return parameters; } @NotNull public static final Map<String, String> toMap(@NotNull QueryParameterCollection $this$toMap) { Intrinsics.checkNotNullParameter($this$toMap, "<this>"); String[] arrayOfString1 = $this$toMap.getKeys(); int $i$f$associateWith = 0; LinkedHashMap<Object, Object> result$iv = new LinkedHashMap<>(RangesKt.coerceAtLeast(MapsKt.mapCapacity(arrayOfString1.length), 16));
/* 63 */     String[] arrayOfString2 = arrayOfString1; int $i$f$associateWithTo = 0; byte b; int i;
/* 64 */     for (b = 0, i = arrayOfString2.length; b < i; ) { Object element$iv$iv = arrayOfString2[b];
...
/*    */     
/* 67 */     return (Map)result$iv; }
/*    */ 
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/client/common/model/QueryParameterCollectionKt.class
