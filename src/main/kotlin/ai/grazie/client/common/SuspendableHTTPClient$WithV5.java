...
/*    */   implements SuspendableHTTPClient
/*    */ {
/*    */   @NotNull
...
/* 78 */     this.client = client; this.authData = authData;
/* 79 */     this.authVersion = AuthVersion.V5; } @NotNull public AuthVersion getAuthVersion() { return this.authVersion; }
/*    */    private final Object appendHeaders(RequestOptions options, Continuation $completion) {
/*    */     AuthData authData;
/* 82 */     if (this.authData == null) if ((AuthData)$completion.getContext().get((CoroutineContext.Key)AuthData.Key) == null) { (AuthData)$completion.getContext().get((CoroutineContext.Key)AuthData.Key); throw new IllegalStateException("For v5 requests metadata must be set"); }
/*    */        
/* 84 */     if ((AuthServiceToken)$completion.getContext().get((CoroutineContext.Key)AuthServiceToken.Key) == null || ((AuthServiceToken)$completion.getContext().get((CoroutineContext.Key)AuthServiceToken.Key)).getToken() == null) ((AuthServiceToken)$completion.getContext().get((CoroutineContext.Key)AuthServiceToken.Key)).getToken();  return ((AuthServiceToken)$completion.getContext().get((CoroutineContext.Key)AuthServiceToken.Key)).getToken().append(authData.getToken(), 
/* 85 */         authData.getOriginalUserToken(), 
/* 86 */         authData.getOriginalServiceToken(), 
/* 87 */         authData.getGrazieAgent(), 
/* 88 */         options);
/*    */   }
/*    */   
/*    */   @Nullable
...
/*    */   
/*    */   @Nullable
/*    */   public Object receiveContinuousSSE(@NotNull String url, @NotNull String content, @NotNull RequestOptions options, boolean reconnect, @NotNull Continuation<? super Flow<ServerSentEvent>> paramContinuation) {
/*    */     // Byte code:
/*    */     //   0: aload #5
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/client/common/SuspendableHTTPClient$WithV5.class
