...
/* 55 */     super(client, HeaderCollectionKt.of(HeaderCollection.Companion, MapsKt.mapOf(TuplesKt.to("Grazie-Authenticate-JWT", CollectionsKt.listOf(token))))); this.token = token;
/* 56 */     this.authVersion = AuthVersion.V3; } @NotNull public AuthVersion getAuthVersion() { return this.authVersion; }
/*    */ 
/*    */   
/*    */   @NotNull
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/client/common/SuspendableHTTPClient$WithV3.class
