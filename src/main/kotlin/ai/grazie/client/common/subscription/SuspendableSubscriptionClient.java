...
/*    */     
/*    */     @Nullable
/* 23 */     public final Object invokeSuspend(@NotNull Object $result) { IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); return Unit.INSTANCE; }  throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine"); } @NotNull public final Continuation<Unit> create(@NotNull Continuation<? super SuspendableSubscriptionClient$subscribe$1> $completion) { return (Continuation<Unit>)new SuspendableSubscriptionClient$subscribe$1($completion); } @Nullable public final Object invoke(@Nullable Continuation<?> p1) { return ((SuspendableSubscriptionClient$subscribe$1)create(p1)).invokeSuspend(Unit.INSTANCE); } } @DebugMetadata(f = "SuspendableSubscriptionClient.kt", l = {}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "ai.grazie.client.common.subscription.SuspendableSubscriptionClient$subscribe$2") @Metadata(mv = {1, 7, 0}, k = 3, xi = 48, d1 = {"\000\b\n\000\n\002\020\002\n\000\020\000\032\0020\001\"\004\b\000\020\002H@"}, d2 = {"<anonymous>", "", "E"}) static final class SuspendableSubscriptionClient$subscribe$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> { int label; SuspendableSubscriptionClient$subscribe$2(Continuation $completion) { super(1, $completion); }
/* 24 */     @Nullable public final Object invokeSuspend(@NotNull Object $result) { IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); return Unit.INSTANCE; }  throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine"); } @NotNull public final Continuation<Unit> create(@NotNull Continuation<? super SuspendableSubscriptionClient$subscribe$2> $completion) { return (Continuation<Unit>)new SuspendableSubscriptionClient$subscribe$2($completion); } @Nullable public final Object invoke(@Nullable Continuation<?> p1) { return ((SuspendableSubscriptionClient$subscribe$2)create(p1)).invokeSuspend(Unit.INSTANCE); } }
/*    */   @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000<\n\002\030\002\n\002\030\002\n\002\020\016\n\000\n\002\030\002\n\002\b\002\n\002\030\002\n\002\b\b\n\002\020\002\n\000\n\002\030\002\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\b\002\030\0002\b\022\004\022\0020\0020\001B\035\022\006\020\003\032\0020\004\022\006\020\005\032\0020\002\022\006\020\006\032\0020\007¢\006\002\020\bJq\020\017\032\0020\0202\034\020\021\032\030\b\001\022\n\022\b\022\004\022\0020\0200\023\022\006\022\004\030\0010\0240\0222\034\020\025\032\030\b\001\022\n\022\b\022\004\022\0020\0200\023\022\006\022\004\030\0010\0240\0222\"\020\026\032\036\b\001\022\004\022\0020\002\022\n\022\b\022\004\022\0020\0200\023\022\006\022\004\030\0010\0240\027H@ø\001\000¢\006\002\020\030R\021\020\003\032\0020\004¢\006\b\n\000\032\004\b\t\020\nR\021\020\006\032\0020\007¢\006\b\n\000\032\004\b\013\020\fR\021\020\005\032\0020\002¢\006\b\n\000\032\004\b\r\020\016\002\004\n\002\b\031¨\006\031"}, d2 = {"Lai/grazie/client/common/subscription/SuspendableSubscriptionClient$WebSocket;", "Lai/grazie/client/common/subscription/SuspendableSubscriptionClient;", "", "client", "Lai/grazie/client/common/websocket/SuspendableWebSocketClient;", "url", "options", "Lai/grazie/client/common/model/RequestOptions;", "(Lai/grazie/client/common/websocket/SuspendableWebSocketClient;Ljava/lang/String;Lai/grazie/client/common/model/RequestOptions;)V", "getClient", "()Lai/grazie/client/common/websocket/SuspendableWebSocketClient;", "getOptions", "()Lai/grazie/client/common/model/RequestOptions;", "getUrl", "()Ljava/lang/String;", "subscribe", "", "onConnect", "Lkotlin/Function1;", "Lkotlin/coroutines/Continuation;", "", "onClose", "onEntity", "Lkotlin/Function2;", "(Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "client-common"}) public static final class WebSocket implements SuspendableSubscriptionClient<String> { @NotNull private final SuspendableWebSocketClient client; @NotNull
...
/*    */       Object L$1; int label; SuspendableSubscriptionClient$WebSocket$subscribe$2(Function1<Continuation<? super Unit>, Object> $onConnect, Function2<String, Continuation<? super Unit>, Object> $onEntity, Function1<Continuation<? super Unit>, Object> $onClose, Continuation $completion) { super(2, $completion); } @Nullable
...
/*    */         //   52	310	0	this	Lai/grazie/client/common/subscription/SuspendableSubscriptionClient$WebSocket$subscribe$2;
/*    */         //   52	310	1	$result	Ljava/lang/Object; } @NotNull
/*    */       public final Continuation<Unit> create(@Nullable Object value, @NotNull Continuation<? super SuspendableSubscriptionClient$WebSocket$subscribe$2> $completion) { SuspendableSubscriptionClient$WebSocket$subscribe$2 suspendableSubscriptionClient$WebSocket$subscribe$2 = new SuspendableSubscriptionClient$WebSocket$subscribe$2(this.$onConnect, this.$onEntity, this.$onClose, $completion);
/*    */         suspendableSubscriptionClient$WebSocket$subscribe$2.L$0 = value;
/*    */         return (Continuation<Unit>)suspendableSubscriptionClient$WebSocket$subscribe$2; } @Nullable
/*    */       public final Object invoke(@NotNull SuspendableWebSocketClient.Session p1, @Nullable Continuation<?> p2) { return ((SuspendableSubscriptionClient$WebSocket$subscribe$2)create(p1, p2)).invokeSuspend(Unit.INSTANCE); }
/*    */     } }
/*    */    @Metadata(mv = {1, 7, 0}, k = 1, xi = 48, d1 = {"\000>\n\002\030\002\n\000\n\002\030\002\n\000\n\002\020\016\n\000\n\002\030\002\n\000\n\002\030\002\n\002\b\b\n\002\020\002\n\000\n\002\030\002\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\b\002\030\000*\004\b\001\020\0012\b\022\004\022\002H\0010\002B+\022\f\020\003\032\b\022\004\022\0020\0040\002\022\f\020\005\032\b\022\004\022\0028\0010\006\022\b\b\002\020\007\032\0020\b¢\006\002\020\tJq\020\020\032\0020\0212\034\020\022\032\030\b\001\022\n\022\b\022\004\022\0020\0210\024\022\006\022\004\030\0010\0250\0232\034\020\026\032\030\b\001\022\n\022\b\022\004\022\0020\0210\024\022\006\022\004\030\0010\0250\0232\"\020\027\032\036\b\001\022\004\022\0028\001\022\n\022\b\022\004\022\0020\0210\024\022\006\022\004\030\0010\0250\030H@ø\001\000¢\006\002\020\031R\027\020\003\032\b\022\004\022\0020\0040\002¢\006\b\n\000\032\004\b\n\020\013R\021\020\007\032\0020\b¢\006\b\n\000\032\004\b\f\020\rR\027\020\005\032\b\022\004\022\0028\0010\006¢\006\b\n\000\032\004\b\016\020\017\002\004\n\002\b\031¨\006\032"}, d2 = {"Lai/grazie/client/common/subscription/SuspendableSubscriptionClient$WithSerializer;", "E", "Lai/grazie/client/common/subscription/SuspendableSubscriptionClient;", "inner", "", "serializer", "Lkotlinx/serialization/KSerializer;", "json", "Lai/grazie/utils/json/JSON;", "(Lai/grazie/client/common/subscription/SuspendableSubscriptionClient;Lkotlinx/serialization/KSerializer;Lai/grazie/utils/json/JSON;)V", "getInner", "()Lai/grazie/client/common/subscription/SuspendableSubscriptionClient;", "getJson", "()Lai/grazie/utils/json/JSON;", "getSerializer", "()Lkotlinx/serialization/KSerializer;", "subscribe", "", "onConnect", "Lkotlin/Function1;", "Lkotlin/coroutines/Continuation;", "", "onClose", "onEntity", "Lkotlin/Function2;", "(Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "client-common"})
/*    */   public static final class WithSerializer<E> implements SuspendableSubscriptionClient<E> {
/*    */     @NotNull
/*    */     private final SuspendableSubscriptionClient<String> inner; @NotNull
/*    */     private final KSerializer<E> serializer; @NotNull
/* 50 */     private final JSON json; public WithSerializer(@NotNull SuspendableSubscriptionClient<String> inner, @NotNull KSerializer<E> serializer, @NotNull JSON json) { this.inner = inner; this.serializer = serializer; this.json = json; } @NotNull public final SuspendableSubscriptionClient<String> getInner() { return this.inner; } @NotNull public final KSerializer<E> getSerializer() { return this.serializer; } @NotNull public final JSON getJson() { return this.json; }
/*    */     
/*    */     @Nullable
...
/*    */       
/*    */       @NotNull
/*    */       public final Continuation<Unit> create(@Nullable Object value, @NotNull Continuation<? super SuspendableSubscriptionClient$WithSerializer$subscribe$2> $completion) {
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/client/common/subscription/SuspendableSubscriptionClient.class
