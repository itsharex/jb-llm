...
/*    */   
/* 29 */   public Response(@NotNull List<String> synonyms) { this.synonyms = synonyms; } @NotNull private final List<String> synonyms; @NotNull public final List<String> getSynonyms() { return this.synonyms; }
/*    */ 
/*    */   
/*    */   @JvmStatic
...
/*    */     output.encodeSerializableElement(serialDesc, 0, (SerializationStrategy)new ArrayListSerializer((KSerializer)StringSerializer.INSTANCE), self.synonyms);
/*    */   }
/*    */   
...
/*    */       return new SynAPI.Synonymize.V2.Response(i, (List)object, null);
/*    */     }
/*    */     
...
/*    */       SynAPI.Synonymize.V2.Response.write$Self(value, compositeEncoder, serialDescriptor);
/*    */       compositeEncoder.endStructure(serialDescriptor);
/*    */     }
/*    */     
/*    */     static {
/*    */       PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("ai.grazie.api.gateway.api.cloud.trf.SynAPI.Synonymize.V2.Response", INSTANCE, 1);
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/api/gateway/api/cloud/trf/SynAPI$Synonymize$V2$Response.class
