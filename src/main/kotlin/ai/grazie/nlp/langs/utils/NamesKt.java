...
/*  7 */     Intrinsics.checkNotNullParameter($this$englishName, "<this>"); Intrinsics.checkNotNullExpressionValue($this$englishName.name().toLowerCase(Locale.ROOT), "this as java.lang.String).toLowerCase(Locale.ROOT)"); String str1 = $this$englishName.name().toLowerCase(Locale.ROOT); char c = str1.charAt(0);
/*    */ 
/*    */ 
/*    */ 
/*    */ 
...
/*    */     Intrinsics.checkNotNullExpressionValue(String.valueOf(c).toUpperCase(Locale.ROOT), "this as java.lang.String).toUpperCase(Locale.ROOT)");
/*    */     String str2 = str1;
/*    */     $i$a$-replaceFirstCharWithCharSequence-NamesKt$englishName$1 = 1;
/*    */     Intrinsics.checkNotNullExpressionValue(str2.substring($i$a$-replaceFirstCharWithCharSequence-NamesKt$englishName$1), "this as java.lang.String).substring(startIndex)");
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/nlp/langs/utils/NamesKt.class
