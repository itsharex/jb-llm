...
/*    */     Intrinsics.checkNotNullExpressionValue(word.toLowerCase(Locale.ROOT), "this as java.lang.String).toLowerCase(Locale.ROOT)");
/*    */     return (CollectionsKt.binarySearch$default(this.commonWordsSorted, word.toLowerCase(Locale.ROOT), 0, 0, 6, null) >= 0);
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/nlp/utils/words/WordListEnglishVocabulary.class
