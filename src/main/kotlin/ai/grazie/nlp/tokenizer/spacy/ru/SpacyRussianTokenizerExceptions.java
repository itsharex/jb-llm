...
/*  52 */       String[] arrayOfString = new String[3]; arrayOfString[0] = abbrev; arrayOfString[1] = TextKt.capitalize(abbrev); Intrinsics.checkNotNullExpressionValue(abbrev.toUpperCase(Locale.ROOT), "this as java.lang.String).toUpperCase(Locale.ROOT)"); arrayOfString[2] = abbrev.toUpperCase(Locale.ROOT); for (String orth : CollectionsKt.listOf((Object[])arrayOfString)) {
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/nlp/tokenizer/spacy/ru/SpacyRussianTokenizerExceptions.class
