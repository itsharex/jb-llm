...
public abstract class Retokenizer implements NonDestructiveTokenizer {
    public Retokenizer(@NotNull NonDestructiveTokenizer tokenizer) {
    ...
    @NotNull
    protected NonDestructiveTokenizer getTokenizer() {
    ...
    public List<Tokenizer.Token> tokenize(@NotNull String text) {
        ...
        List<Tokenizer.Token> tokenized = getTokenizer().tokenize(text);
        Iterable<Tokenizer.Token> $this$sortedBy$iv = retokenize(text, tokenized);
        int $i$f$sortedBy = 0;
        List<Tokenizer.Token> retokenized =
                CollectionsKt.sortedWith($this$sortedBy$iv, new Retokenizer$tokenize$$inlined$sortedBy$1());
    ...
    static final class Retokenizer$mergeSequences$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Tokenizer.Token>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object $result) {
            ...
            //   5: aload_0
            //   6: getfield label : I
            //   9: tableswitch default -> 1429, 0 -> 48, 1 -> 124, 2 -> 243, 3 -> 482, 4 -> 935, 5 -> 1379
            //   48: aload_1
            ...
            //   1393: goto -> 60
            //   1396: aload #4
            //   1398: invokevirtual getRange : ()Lkotlin/ranges/IntRange;
            //   1401: aload_3
            //   1402: invokevirtual getRange : ()Lkotlin/ranges/IntRange;
            //   1405: <illegal opcode> makeConcatWithConstants : (Lkotlin/ranges/IntRange;Lkotlin/ranges/IntRange;)Ljava/lang/String;
            //   1410: astore #5
            //   1412: new java/lang/IllegalStateException
            //   1415: dup
            //   1416: aload #5
            //   1418: invokevirtual toString : ()Ljava/lang/String;
            //   1421: invokespecial <init> : (Ljava/lang/String;)V
            //   1424: athrow
            //   1425: getstatic kotlin/Unit.INSTANCE : Lkotlin/Unit;
            //   1428: areturn
            //   1429: new java/lang/IllegalStateException
            //   1432: dup
            //   1433: ldc 'call to 'resume' before 'invoke' with coroutine'
            ...
            //   1396	29	3	initial	Lai/grazie/nlp/tokenizer/Tokenizer$Token;
            ...
            //   1396	29	4	current	Lai/grazie/nlp/tokenizer/Tokenizer$Token;
            ...
            //   52	1377	0	this	Lai/grazie/nlp/tokenizer/retokenizer/Retokenizer$mergeSequences$1;
            //   52	1377	1	$result	Ljava/lang/Object;
        }

        @NotNull
        public final Continuation<Unit> create(@Nullable Object value, @NotNull Continuation<? super Retokenizer$mergeSequences$1> $completion) {
