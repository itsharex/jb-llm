...
/*    */   static final class BasicWordTokenizer$tokenizeAsSequence$1 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super Tokenizer.Token>, Continuation<? super Unit>, Object> {
/*    */     Object L$1;
/*    */     int label; BasicWordTokenizer$tokenizeAsSequence$1(Sequence<Character> $text, Continuation $completion) { super(2, $completion); } @Nullable
...
/*    */       //   36	208	1	$result	Ljava/lang/Object; } @NotNull
/*    */     public final Continuation<Unit> create(@Nullable Object value, @NotNull Continuation<? super BasicWordTokenizer$tokenizeAsSequence$1> $completion) { BasicWordTokenizer$tokenizeAsSequence$1 basicWordTokenizer$tokenizeAsSequence$1 = new BasicWordTokenizer$tokenizeAsSequence$1(this.$text, $completion);
/*    */       basicWordTokenizer$tokenizeAsSequence$1.L$0 = value;
/*    */       return (Continuation<Unit>)basicWordTokenizer$tokenizeAsSequence$1; } @Nullable
...
/*    */       //   183	29	4	char	C
/*    */       //   85	24	5	cp	I
/*    */       //   40	210	0	this	Lai/grazie/nlp/tokenizer/word/BasicWordTokenizer$cleanText$1;
/*    */       //   40	210	1	$result	Ljava/lang/Object;
/*    */     }
/*    */     
/*    */     @NotNull
/*    */     public final Continuation<Unit> create(@Nullable Object value, @NotNull Continuation<? super BasicWordTokenizer$cleanText$1> $completion) {
...
/*    */       //   196	95	7	char	C
/*    */       //   346	8	7	char	C
/*    */       //   44	398	0	this	Lai/grazie/nlp/tokenizer/word/BasicWordTokenizer$splitOnPunctuation$1;
/*    */       //   44	398	1	$result	Ljava/lang/Object;
/*    */     }
/*    */     
/*    */     @NotNull
/*    */     public final Continuation<Unit> create(@Nullable Object value, @NotNull Continuation<? super BasicWordTokenizer$splitOnPunctuation$1> $completion) {
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/nlp/tokenizer/word/BasicWordTokenizer.class
