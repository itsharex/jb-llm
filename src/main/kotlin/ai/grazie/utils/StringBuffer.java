...
/* 84 */     return this.text.length();
/*    */   } public char get(int index) {
/* 86 */     return this.text.charAt(index);
/*    */   } @NotNull
/*    */   public CharSequence subSequence(int startIndex, int endIndex) {
/* 89 */     return this.text.subSequence(startIndex, endIndex);
/*    */   }
/*    */   
/*    */   public final void replace(int start, int endExclusive, @NotNull String value) {
/* 93 */     Intrinsics.checkNotNullParameter(value, "value"); Intrinsics.checkNotNullExpressionValue(this.text.substring(0, start), "this as java.lang.String…ing(startIndex, endIndex)"); Intrinsics.checkNotNullExpressionValue(this.text.substring(endExclusive, this.text.length()), "this as java.lang.String…ing(startIndex, endIndex)"); this.text = this.text.substring(0, start) + this.text.substring(0, start) + value;
/*    */   }
/*    */   @NotNull
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/StringBuffer.class
