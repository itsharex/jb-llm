...
/* 28 */             Intrinsics.checkNotNullExpressionValue(Files.createDirectories(entryPath, (FileAttribute<?>[])Arrays.copyOf(new FileAttribute[0], (new FileAttribute[0]).length)), "createDirectories(this, *attributes)"); Files.createDirectories(entryPath, (FileAttribute<?>[])Arrays.copyOf(new FileAttribute[0], (new FileAttribute[0]).length)); continue;
/*    */           }  }
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/Zip.class
