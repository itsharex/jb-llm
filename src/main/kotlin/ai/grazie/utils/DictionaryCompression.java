...
/* 18 */       public DictionaryCompression.Getter<?> deserialize(@NotNull Decoder decoder) { Intrinsics.checkNotNullParameter(decoder, "decoder"); return new DictionaryCompression.Getter(decoder.decodeInt()); }
/*    */        @NotNull
/*    */       public SerialDescriptor getDescriptor() {
/* 21 */         return SerialDescriptorsKt.PrimitiveSerialDescriptor("Getter", (PrimitiveKind)PrimitiveKind.INT.INSTANCE);
/*    */       }
/*    */       public void serialize(@NotNull Encoder encoder, @NotNull DictionaryCompression.Getter value) {
/* 24 */         Intrinsics.checkNotNullParameter(encoder, "encoder"); Intrinsics.checkNotNullParameter(value, "value"); encoder.encodeInt(value.getId());
/*    */       } }
/*    */   
/*    */   }
/*    */   
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/DictionaryCompression.class
