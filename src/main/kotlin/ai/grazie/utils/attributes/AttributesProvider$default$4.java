...
/*    */ final class AttributesProvider$default$4
/*    */   extends Lambda
...
/* 34 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, Long.valueOf(((Attributes.Value.Long)value).getValue()));
/*    */   }
/*    */   
/*    */   AttributesProvider$default$4(Function3<Attributes.Key.Long, Entity, Long, Attributes.Value.Long> $set) {
/*    */     super(3);
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/attributes/AttributesProvider$default$4.class
