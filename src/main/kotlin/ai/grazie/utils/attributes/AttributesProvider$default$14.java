...
/* 79 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, ((Attributes.Value.Bytes)value).getValue());
/*    */   }
/*    */   
/*    */   AttributesProvider$default$14(Function3<Attributes.Key.Bytes, Entity, byte[], Attributes.Value.Bytes> $set) {
/*    */     super(3);
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/attributes/AttributesProvider$default$14.class
