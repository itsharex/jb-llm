...
/*    */ final class AttributesProvider$default$10
/*    */   extends Lambda
...
/* 61 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, ((Attributes.Value.Json)value).getValue());
/*    */   }
/*    */   
/*    */   AttributesProvider$default$10(Function3<Attributes.Key.Json, Entity, String, Attributes.Value.Json> $set) {
/*    */     super(3);
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/attributes/AttributesProvider$default$10.class
