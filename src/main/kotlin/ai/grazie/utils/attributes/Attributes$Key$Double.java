...
/*    */     return !!Intrinsics.areEqual(getFqdn(), double_.getFqdn());
/*    */   }
/*    */   
/*    */   public int hashCode() {
...
/*    */     return "Double(fqdn=" + getFqdn() + ")";
/*    */   }
/*    */   
/*    */   @NotNull
/*    */   public final Double copy(@NotNull String fqdn) {
/*    */     Intrinsics.checkNotNullParameter(fqdn, "fqdn");
/*    */     return new Double(fqdn);
/*    */   }
/*    */   
/*    */   @NotNull
