...
/* 86 */     Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(id, Long.valueOf(((Attributes.Value.Long)value).getValue()));
/*    */   }
/*    */   
/*    */   AttributesProvider$provide$2(Function2<Entity, Long, Attributes.Value.Long> $set) {
/*    */     super(2);
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/attributes/AttributesProvider$provide$2.class
