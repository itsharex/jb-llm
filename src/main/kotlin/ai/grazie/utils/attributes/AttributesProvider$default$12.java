...
/* 70 */     Intrinsics.checkNotNullParameter(key, "key"); Intrinsics.checkNotNullParameter(value, "value"); return (Attributes.Value)this.$set.invoke(key, id, Boolean.valueOf(((Attributes.Value.Bool)value).getValue()));
/*    */   }
/*    */   
/*    */   AttributesProvider$default$12(Function3<Attributes.Key.Bool, Entity, Boolean, Attributes.Value.Bool> $set) {
/*    */     super(3);
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/attributes/AttributesProvider$default$12.class
