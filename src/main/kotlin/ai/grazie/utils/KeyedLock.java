...
/*    */   @Nullable public final <T> Object withLock(@NotNull Object key, @NotNull Function2 body, @NotNull Continuation<? super T> paramContinuation) { // Byte code:
/*    */     //   0: aload_3
...
/* 23 */       return KeyedLock.this.withLock(null, null, (Continuation)this); } } private static final Pair withLock$lambda$0(Function2 $tmp0, Object p0, Object p1) { Intrinsics.checkNotNullParameter($tmp0, "$tmp0"); return (Pair)$tmp0.invoke(p0, p1); } @Metadata(mv = {1, 7, 0}, k = 3, xi = 48, d1 = {"\000\032\n\000\n\002\030\002\n\002\020\b\n\002\030\002\n\002\b\002\n\002\020\000\n\002\b\004\020\000\032\020\022\004\022\0020\002\022\004\022\0020\003\030\0010\001\"\004\b\000\020\004\"\b\b\001\020\005*\0020\0062\006\020\007\032\002H\0052\024\020\b\032\020\022\004\022\0020\002\022\004\022\0020\003\030\0010\001H\n¢\006\004\b\t\020\n"}, d2 = {"<anonymous>", "Lkotlin/Pair;", "", "Lai/grazie/utils/SimpleMutex;", "T", "KeyT", "", "<anonymous parameter 0>", "countAndLock", "invoke", "(Ljava/lang/Object;Lkotlin/Pair;)Lkotlin/Pair;"}) static final class KeyedLock$withLock$2 extends Lambda implements Function2<KeyT, Pair<? extends Integer, ? extends SimpleMutex>, Pair<? extends Integer, ? extends SimpleMutex>> { @Nullable
/* 24 */     public final Pair<Integer, SimpleMutex> invoke(@NotNull KeyT param1KeyT, @Nullable Pair countAndLock) { Intrinsics.checkNotNullParameter(param1KeyT, "<anonymous parameter 0>"); if (countAndLock != null) { Pair it = countAndLock; int $i$a$-let-KeyedLock$withLock$2$1 = 0;
...
/*    */     @Nullable
/* 29 */     public final Object invokeSuspend(@NotNull Object $result) { Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); this.label = 1; return (this.$body.invoke(this.$key, this) == object) ? object : this.$body.invoke(this.$key, this);case 1: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); return SYNTHETIC_LOCAL_VARIABLE_1; }  throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine"); } @NotNull public final Continuation<Unit> create(@NotNull Continuation<? super KeyedLock$withLock$result$1> $completion) { return (Continuation<Unit>)new KeyedLock$withLock$result$1(this.$body, this.$key, $completion); }
/*    */     @Nullable public final Object invoke(@Nullable Continuation<?> p1) { return ((KeyedLock$withLock$result$1)create(p1)).invokeSuspend(Unit.INSTANCE); } }
/* 31 */   private static final Pair withLock$lambda$1(Function2 $tmp0, Object p0, Object p1) { Intrinsics.checkNotNullParameter($tmp0, "$tmp0"); return (Pair)$tmp0.invoke(p0, p1); } @Metadata(mv = {1, 7, 0}, k = 3, xi = 48, d1 = {"\000\032\n\000\n\002\030\002\n\002\020\b\n\002\030\002\n\002\b\002\n\002\020\000\n\002\b\004\020\000\032\020\022\004\022\0020\002\022\004\022\0020\003\030\0010\001\"\004\b\000\020\004\"\b\b\001\020\005*\0020\0062\006\020\007\032\002H\0052\024\020\b\032\020\022\004\022\0020\002\022\004\022\0020\003\030\0010\001H\n¢\006\004\b\t\020\n"}, d2 = {"<anonymous>", "Lkotlin/Pair;", "", "Lai/grazie/utils/SimpleMutex;", "T", "KeyT", "", "<anonymous parameter 0>", "countAndLock", "invoke", "(Ljava/lang/Object;Lkotlin/Pair;)Lkotlin/Pair;"}) static final class KeyedLock$withLock$3 extends Lambda implements Function2<KeyT, Pair<? extends Integer, ? extends SimpleMutex>, Pair<? extends Integer, ? extends SimpleMutex>> { @Nullable
/* 32 */     public final Pair<Integer, SimpleMutex> invoke(@NotNull KeyT param1KeyT, @Nullable Pair countAndLock) { Intrinsics.checkNotNullParameter(param1KeyT, "<anonymous parameter 0>"); Intrinsics.checkNotNull(countAndLock); int count = ((Number)countAndLock.component1()).intValue();
/* 33 */       return (count == 1) ? 
/* 34 */         null : 
/*    */         
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/utils/KeyedLock.class
