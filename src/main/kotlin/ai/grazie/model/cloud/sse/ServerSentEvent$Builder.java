...
/*    */       int colonIndex = StringsKt.indexOf$default(line, ":", 0, false, 6, null); Intrinsics.checkNotNullExpressionValue(line.substring(colonIndex + 1), "this as java.lang.String).substring(startIndex)"); Pair pair = (colonIndex == -1) ? TuplesKt.to(line, "") : TuplesKt.to(StringsKt.substring(line, RangesKt.until(0, colonIndex)), trimFirstSpace(line.substring(colonIndex + 1))); String field = (String)pair.component1(), value = (String)pair.component2(); String str1 = field; switch (str1.hashCode()) {
/*    */         case 0:
/*    */           if (!str1.equals(""))
/*    */             break;  Intrinsics.checkNotNullExpressionValue(this.commentBuilder.append(value), "append(value)"); Intrinsics.checkNotNullExpressionValue(this.commentBuilder.append(value).append('\n'), "append('\\n')");
/*    */           this.commentBuilder.append(value).append('\n');
/*    */           return;
/*    */         case 3076010:
/*    */           if (!str1.equals("data"))
/*    */             break; 
/*    */           Intrinsics.checkNotNullExpressionValue(this.dataBuilder.append(value), "append(value)");
/*    */           Intrinsics.checkNotNullExpressionValue(this.dataBuilder.append(value).append('\n'), "append('\\n')");
...
/*    */           return;
/*    */       } 
/*    */       MPPLogger.error$default(this.logger, new ServerSentEvent$Builder$appendLine$1(field), null, 2, null);
/*    */     } else {
/*    */       this.entire = true;
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/model/cloud/sse/ServerSentEvent$Builder.class
