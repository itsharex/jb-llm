...
/*    */   @NotNull
/*  9 */   public final KSerializer<LLMChat> serializer() { return (KSerializer<LLMChat>)LLMChat.$serializer.INSTANCE; } private Companion() {} @NotNull
/*    */   public final LLMChat build(@NotNull Function1 body) {
/* 11 */     Intrinsics.checkNotNullParameter(body, "body"); LLMChat.Builder builder = new LLMChat.Builder(null, 1, null); body.invoke(builder); return builder.build();
/*    */   }
/*    */ }


/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/model/llm/chat/LLMChat$Companion.class
