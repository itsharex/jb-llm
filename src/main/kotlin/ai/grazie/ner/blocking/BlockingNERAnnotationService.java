...
/*    */   default SentenceWithNERAnnotations reannotate(@NotNull SentenceWithNERAnnotations sentence) { Intrinsics.checkNotNullParameter(sentence, "sentence");
/*    */     return new SentenceWithNERAnnotations(sentence.getText(), (SentenceWithNERAnnotations.Annotation[])ArraysKt.plus((Object[])sentence.getAnnotations(), (Object[])annotate(sentence.getText()).getAnnotations())); } @NotNull
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/ner/blocking/BlockingNERAnnotationService.class
