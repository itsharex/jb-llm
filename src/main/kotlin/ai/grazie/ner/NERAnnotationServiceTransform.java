...
/*    */   public static final class NERAnnotationServiceTransform$blocking$2 implements BlockingNERAnnotationService { NERAnnotationServiceTransform$blocking$2(CoroutineContext $context, SuspendableNERAnnotationService $service) {} @NotNull
/* 38 */     public List<SentenceWithNERAnnotations> annotate(@NotNull List<String> sentences) { Intrinsics.checkNotNullParameter(sentences, "sentences"); return (List<SentenceWithNERAnnotations>)BuildersKt.runBlocking(this.$context, new NERAnnotationServiceTransform$blocking$2$annotate$1(this.$service, sentences, null)); } @DebugMetadata(f = "NERAnnotationServiceTransform.kt", l = {38}, i = {}, s = {}, n = {}, m = "invokeSuspend", c = "ai.grazie.ner.NERAnnotationServiceTransform$blocking$2$annotate$1") @Metadata(mv = {1, 7, 0}, k = 3, xi = 48, d1 = {"\000\016\n\000\n\002\020 \n\002\030\002\n\002\030\002\020\000\032\b\022\004\022\0020\0020\001*\0020\003H@"}, d2 = {"<anonymous>", "", "Lai/grazie/ner/model/SentenceWithNERAnnotations;", "Lkotlinx/coroutines/CoroutineScope;"}) static final class NERAnnotationServiceTransform$blocking$2$annotate$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends SentenceWithNERAnnotations>>, Object> { int label; NERAnnotationServiceTransform$blocking$2$annotate$1(SuspendableNERAnnotationService $service, List<String> $sentences, Continuation $completion) { super(2, $completion); } @Nullable public final Object invokeSuspend(@NotNull Object $result) { Object object = IntrinsicsKt.getCOROUTINE_SUSPENDED(); switch (this.label) { case 0: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); this.label = 1; return (this.$service.annotate(this.$sentences, (Continuation)this) == object) ? object : this.$service.annotate(this.$sentences, (Continuation)this);case 1: ResultKt.throwOnFailure(SYNTHETIC_LOCAL_VARIABLE_1); return SYNTHETIC_LOCAL_VARIABLE_1; }  throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine"); } @NotNull
/*    */       public final Continuation<Unit> create(@Nullable Object value, @NotNull Continuation<? super NERAnnotationServiceTransform$blocking$2$annotate$1> $completion) {
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/ner/NERAnnotationServiceTransform.class
