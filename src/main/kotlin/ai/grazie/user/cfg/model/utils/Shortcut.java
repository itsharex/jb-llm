...
/*    */ 
/*    */     
/* 59 */     this.os = os; } @JvmStatic public static final void write$Self(@NotNull Shortcut self, @NotNull CompositeEncoder output, @NotNull SerialDescriptor serialDesc) { Intrinsics.checkNotNullParameter(self, "self"); Intrinsics.checkNotNullParameter(output, "output"); Intrinsics.checkNotNullParameter(serialDesc, "serialDesc"); output.encodeSerializableElement(serialDesc, 0, (SerializationStrategy)Keystroke.$serializer.INSTANCE, self.firstStroke); if (output.shouldEncodeElementDefault(serialDesc, 1) ? true : ((self.secondStroke != null))) output.encodeNullableSerializableElement(serialDesc, 1, (SerializationStrategy)Keystroke.$serializer.INSTANCE, self.secondStroke);  if (output.shouldEncodeElementDefault(serialDesc, 2) ? true : ((self.os != 14))) output.encodeIntElement(serialDesc, 2, self.os);  } public final int getOs() { return this.os; }
/*    */ 
/*    */   
...
/*    */         object1 = compositeDecoder.decodeSerializableElement(serialDescriptor, 0, (DeserializationStrategy)Keystroke.$serializer.INSTANCE, object1);
/*    */         i |= 0x1;
/*    */         object2 = compositeDecoder.decodeNullableSerializableElement(serialDescriptor, 1, (DeserializationStrategy)Keystroke.$serializer.INSTANCE, object2);
/*    */         i |= 0x2;
...
/*    */       return new Shortcut(i, (Keystroke)object1, (Keystroke)object2, j, null);
/*    */     }
/*    */     
...
/*    */       Shortcut.write$Self(value, compositeEncoder, serialDescriptor);
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/user/cfg/model/utils/Shortcut.class
