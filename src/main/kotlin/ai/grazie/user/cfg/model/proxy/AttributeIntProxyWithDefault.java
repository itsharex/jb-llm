...
/* 10 */     Intrinsics.checkNotNullParameter(attributes, "attributes"); attributes.getDouble(this.key); return (attributes.getDouble(this.key) != null) ? (int)attributes.getDouble(this.key).getValue() : this.default;
/*    */   }
/*    */   
/*    */   @Nullable
...
/* Location:              /Volumes/Macintosh HD/Users/phodal/Desktop/ml-llm.jar!/ai/grazie/user/cfg/model/proxy/AttributeIntProxyWithDefault.class
